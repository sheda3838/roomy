...
function buildRoommateFactors(currentUser: IUser, targetUser: IUser, facilityMatches: any, locationMatches: any) {
  ...
  factors.push({
    ...
    status: (cleanDiff === 0 ? "perfect" : cleanDiff === 1 ? "partial" : "conflict") as "perfect" | "partial" | "conflict",
  ...
  factors.push({
    ...
    status: (guestDiff === 0 ? "perfect" : guestDiff === 1 ? "partial" : "conflict") as "perfect" | "partial" | "conflict",
  ...
  factors.push({
    ...
    status: (roleMatch ? "perfect" : "conflict") as "perfect" | "partial" | "conflict",
